  ...
  PrinterCalc.ThreeManager = {
    ...
    initViewer: function (container) {
      ...
      try {
        ...
        const isDarkMode = (PrinterCalc.Utils && typeof PrinterCalc.Utils.getCurrentTheme === 'function')
          ? PrinterCalc.Utils.getCurrentTheme() === 'dark'
    ...
    // Set up resize observer with fallback
...
// Use local debounce function to prevent dependency issues
